...
public class lichtap extends javax.swing.JFrame {
    ...
    public void codegiaodien(int User){
        ...
        // Logo
        {ImageIcon originalIcon = new ImageIcon(getClass().getResource("/logo/anhlogo.png"));
        ...
        ImageIcon streakImgIcon = new ImageIcon(getClass().getResource("/logo/Streak.png"));
        ...
        //buoi 1
        contentPanel.add(createBuoiTapPanel("Buổi 1", "Dễ", "/logo/hinhanh.png", 0, 10));
        contentPanel.add(createBuoiTapPanel("Buổi 2", "Trung bình", "/logo/hinhanh.png", 620, 10));
        contentPanel.add(createBuoiTapPanel("Buổi 3", "Khó", "/logo/hinhanh.png", 0, 320));
        contentPanel.add(createBuoiTapPanel("Buổi 4", "Dễ", "/logo/hinhanh.png", 620, 320));
    ...
    private JPanel createBuoiTapPanel(String tenBuoi, String mucDo, String hinhAnhPath, int x, int y) {
